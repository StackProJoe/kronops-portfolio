...
const projects: Project[] = [
  {
    ...
    cardDescription: 'SaaS for realtors — upload a legal property document, get a plain-English analysis in seconds. n8n backend on a VPS, Cloudflare Pages front, Stripe billing.',
    type: 'B2B SaaS',
    status: 'deployed',
    statusLabel: 'Deployed · Live',
    stack: ['Cloudflare Pages', 'n8n', 'Stripe', 'GitHub CI'],
    accentStack: ['n8n'],
    liveUrl: 'https://swiftdocpro.com',
    githubPrivate: false,
    ...
    outcomes: [
      ...
      'Stripe billing integrated and running',
    ...
    savings: {
      ...
      minutesPerDoc: 60,
      docsPerDay: 2,
      headline: 'An hour a document. {Twice a day.} Gone.',
      intro:
